    ...
    <Collapsible open={isOpen} onOpenChange={onToggle}>
      ...
      <CollapsibleContent>
        <Card className="mt-2 p-4 bg-white text-gray-900">
          <p className="mb-4">{responseDetails.context}</p>
          <div className="text-sm text-gray-600 mb-4">
            <p>
              <strong>Book:</strong> {responseDetails.book}
            </p>
            <p>
              <strong>Auther:</strong> {responseDetails.auther}
            </p>
            <p>
              <strong>Chapter:</strong> {responseDetails.chapter}
            </p>
            <p>
              <strong>Topic:</strong> {responseDetails.topic}
            </p>
            <p>
    ...
    <div className="space-y-4 max-w-3xl mx-auto">
      {messages.map((message, index) => (
        <div key={index} className="space-y-2">
          ...
          {/* it use to show other three responce  */}
